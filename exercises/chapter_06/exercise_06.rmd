...
Within your exercise directory, create a directory called `modelsim`. Copy the `mammals.tre` file from Exercise 03 into this new `exercise_06/modelsim` directory. We will use this topology for simulating the data.

Then run the following commands, either in a  `job.sh` script in this new directory with the following contents, and run it with `sbatch`:
...
# GTR - 
seq-gen -mGTR -f0.3841,0.1182,0.1646,0.333 -r1.0051,3.5164,2.2921,0.9079,5.9252,1.0000 -i0.1363 -a0.9978 -g4  -s0.001 -l1000 -of < mammal.tre > mamm
al_gtr_ig.fasta
