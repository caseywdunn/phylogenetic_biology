...
```{r practice-cnidaria, echo=FALSE, fig.cap="A view of the sequence data available for Cnidaria. Here I have selected to view available Nucleotide, Protein, SRA, Genome, and Assembly data.", out.width="100%"}
