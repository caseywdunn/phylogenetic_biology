...
```{r inference-toy, fig.cap="The toy phylogeny we will use to examine inference. Node numbers are in black. Edge lengths are gray numbers below branches. Tip node states are within boxes."}
