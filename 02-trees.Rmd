...
```{r trees-mammal, echo=FALSE, fig.cap="A mammal phylogeny of some mammals downloaded from http://vertlife.org ."}
...
p = ggtree(tree) %<+% d + 
  geom_tiplab( aes(image=uid ), geom="phylopic", offset=5, size=0.1 ) +
  geom_tiplab( aes(label=label ), offset = 40) +
  xlim(0, 400)
