...
p_unrooted = ggtree(tree, layout="unrooted") %<+% d_ingroup +
  geom_tiplab(aes(image=paste0("figures/phylopic/", uid, '.512.png')), geom="image", offset=30, size=phylopic_size_small ) +
...
p_min = tree_star %>%
  ...
  #geom_tiplab(aes(image=paste0("figures/phylopic/", uid, '.512.png')), geom="image", offset=phylopic_offset_small, size=phylopic_size_small ) +
  xlim(0, 2) +
