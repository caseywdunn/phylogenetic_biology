...
Now we need $\boldsymbol{\Pi}$. We noted earlier that humans have a GC content of 41%, so we'll use that. This gives the following entries for $\boldsymbol{\Pi}$:
