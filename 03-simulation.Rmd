...
The mathematical, statistical, and computational machinery above describes the evolution of one DNA site along one edge in a phylogeny according to a simple model. In fact, this is the simplest possible model of DNA evolution, named JC69 after the scientists who described it in 1969 [@jc1969]. It is only one parameter -- the rate of evolution $\mu$. We can even just set $\mu=1$ and just let differences in edge length explain the expected amount of change. It is highly idealized -- there are many important facts about DNA and DNA evolution that it deliberately omits. 
...
To build toward that that General model, let's first expand the JC69 model.
